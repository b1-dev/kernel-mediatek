...
void dram_row_size_test (void) 
{
	...
	print ("Dram row size test\n");
	u4reg=(*(volatile unsigned int *)0xC0003000)&0xFFFFCFFF;
	 *(volatile unsigned int *)0xC0003000=(u4reg|0x3000); // 8Gb size (for different row type memory using)
  ...
  u4Addr=0x20000000;
    ...
    *(u4Addr+i)=(u4Pattern+i);    
    ...
    if((*(u4Addr+i))==(u4Pattern+i))
	 ...
	 if(u4cnt == 8)
	 {	 	  
	 	  *(volatile unsigned int *)0xC0003000=(u4reg|0x2000);// 4Gb
	  	 emi_settings[0].DRAM_RANK_SIZE[0]=0x20000000;
	  	 emi_settings[0].DRAM_RANK_SIZE[1]=0x0;
	 	  print ("Dram size 4Gb\n");
	 }	
	 else if (u4cnt == 0)
	 {
	 	  *(volatile unsigned int *)0xC0003000=(u4reg|0x3000); // 8Gb
	 	   emi_settings[0].DRAM_RANK_SIZE[0]=0x40000000;
	  	 emi_settings[0].DRAM_RANK_SIZE[1]=0x0;
	 	  print ("Dram size 8Gb\n");
	 }	
	 else
