  ...
  if (!OV7675_Sensor_Driver.MODE_CAPTURE) { 
	...
	{      spin_lock(&ov7675_yuv_drv_lock);
	    ...
	    else 
	   {
			  ...
			  OV7675_Set_Dummy(0, 0); //OV7675_Set_Dummy(0,42);
...
OV7675_write_cmos_sensor(0x3d, 0xc3);
...
static BOOL OV7675_set_param_wb(UINT16 para)
{
	...
	if(para != AWB_MODE_OFF) exifAwb = para;
...
void OV7675GetExifInfo(UINT32 exifAddr)
{
    ...
    SENSORDB("[OV7675GetExifInfo] awbmode=%d\n", exifAwb);
    pExifInfo->FNumber = 28;
    pExifInfo->AEISOSpeed = AE_ISO_100;
    pExifInfo->AWBMode = exifAwb;
